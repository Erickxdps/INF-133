...
nuevo_estudiante = {
    "nombre": "Juanito",
    "apellido": "Perez",
    "carrera": "Ingenieria Cevel",
}
put_response = requests.request(method="PUT", url=ruta_post, json=nuevo_estudiante)
print(post_response.text)
...
delete_response = requests.request(method="DELETE", url=ruta_post, json=nuevo_estudiante)
print("DELETE")
print(post_response.text)
